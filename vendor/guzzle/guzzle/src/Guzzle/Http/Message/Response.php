...
class Response extends AbstractMessage implements \Serializable {
	...
	public function __construct($statusCode, $headers = null, $body = null) {
		...
		$this->body = EntityBody::factory(null !== $body ? $body : '');
	...
	public function calculateAge() {
		...
		if (null === $age && $this->getDate()) {
			$age = time() - strtotime($this->getDate());
		}

		return null === $age ? null : (int) (string) $age;
	}
	...
	public function isFresh() {
		...
		return null === $fresh ? null : $fresh >= 0;
	}
	...
	public function isSuccessful() {
		return ($this->statusCode >= 200 && $this->statusCode < 300) || 304 == $this->statusCode;
	}
